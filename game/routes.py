...
from game.parser import game_parse
...
class GameResources(Resource):
    ...
    def post(self):
        ...
        if not args.get('range_from'):
            args['range_from'] = DEFAULT_RANGE_OF_NUMBERS[0]
        if not args.get('range_to'):
            args['range_to'] = DEFAULT_RANGE_OF_NUMBERS[1]
