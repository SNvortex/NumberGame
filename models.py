...
class Game(db.Model):
    ...
    player_id = db.relationship('GameUser', secondary=game_players, backref=db.backref('players'))
    ...
    def __init__(self, secret_number, attempt, author_id, range_from, range_to, password):
